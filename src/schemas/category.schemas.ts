...
const categoryReturnRealEstateSchema =categorySchema.extend({realEstate:realEstateReturnSchema.array()})


export { categorySchema, categoryCreateSchema, categoryReadSchema,categoryHousesReadSchema,categoryReturnRealEstateSchema};
