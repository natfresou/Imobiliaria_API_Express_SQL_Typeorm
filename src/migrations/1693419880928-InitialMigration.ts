...
export class InitialMigration1693419880928 implements MigrationInterface {
    name = 'InitialMigration1693419880928'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "realEstates" ("id" SERIAL NOT NULL, "sold" boolean NOT NULL DEFAULT 'false', "value" numeric(12,2) NOT NULL DEFAULT '0', "size" integer NOT NULL, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "adressId" integer, "categoryId" integer, CONSTRAINT "REL_75facd1c24e1de014d33f1c4a4" UNIQUE ("adressId"), CONSTRAINT "PK_57badbed001c9b97de867eaa976" PRIMARY KEY ("id"))`);
