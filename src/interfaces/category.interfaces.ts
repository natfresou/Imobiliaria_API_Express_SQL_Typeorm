...
import { categoryCreateSchema, categorySchema,categoryHousesReadSchema, categoryReturnRealEstateSchema } from "../schemas";
...
export   {CategoryCreate , CategoryReturn  , CategorysRead,CategoryHousesRead,CategoryReturnRealEstate };
