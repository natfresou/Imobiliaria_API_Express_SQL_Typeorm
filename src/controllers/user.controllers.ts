...
import { createUserService, destroyUserService, readUserService, updateUserService } from "../services";
...
const destroyUserController = async (req: Request, res: Response): Promise<Response> => {
...
export { createUserController,readUserController,destroyUserController,updateUserController};